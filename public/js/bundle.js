...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "D:\\MY WEB DEV PROJECTS\\NATOURS PROJECT",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJhdGhhbXBhbmNob2xpNyIsImEiOiJja3Q0bHdhZHoxNWVzMnBzMnh2eDh4ZTV5In0.IR37Z0RCsTvbObaSznmMNA';
...
var stripe = Stripe('pk_test_51JZbh5SHE49WlF3OqvG6e2nm1ax5puVsHg4iYv0qQS6rIzhT9AfBoYyoaQv0DXlpImzZ1FRTW4IXryNWp3Fn2nQP00jpAb4r8Q');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //redirecting users to checkout Page
...
//MAP
var mapBox = document.getElementById('map'); //Form

var form = document.querySelector('.form-login'); //Logout Button

var logOutBtn = document.querySelector('.nav__el--logout'); //user forms

var userPasswordForm = document.querySelector('.form-user-password');
var userDataForm = document.querySelector('.form-user-data'); //buy tour button
